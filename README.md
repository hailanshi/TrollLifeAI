...
- **职业深度线**：12 个行业 × 5 级职位阶梯 + 行业景气周期（风口/景气/平稳/下行/寒冬），绩效、司龄、晋升、寒冬裁员、跳槽谈薪全自动推进
- **家庭代际线**：子女会跟着你一起变老（婴儿→幼儿→小学→中学→大学→成年→成家），每个阶段有专属剧情；子女成年后好感高会主动反哺
...
| 玩法增强层自检（16 种行动、关系互动、评分、3 槽位存档、年龄纠偏、前提校验、名字与性别、快进 10 年、职业阶梯、子女世代） | ✅ 15/15 项 |
